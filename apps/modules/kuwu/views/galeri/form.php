...
<form  role="form" id="xfrm" enctype="multipart/form-data" data-toggle="validator" class="form-horizontal" >
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="fg-line">
                <input value="<?= (isset($arey)) ? $arey['galeri_text'] : ''; ?>" class="form-control" placeholder="judul" type="text" name="galeri_text" id="image_name" required data-error="Wajib diisi."  data-toggle="popover" data-placement="top" data-content="">
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <div class="select">
                <select id="cat_id" name="cat_id" class="form-control selectpicker" data-live-search="false" data-default="<?= (isset($arey)) ? $arey['cat_id'] : ''; ?>">
                    <option value="">--Pilihan--</option>
                    <?php
                    $n = (isset($arey)) ? $arey['cat_id'] : '';;
                    $k = $this->Data_model->selectData(DB_GALERI_CAT, 'cat_id');
                    foreach ($k as $m):
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <div class="fg-line">
                <input value="<?= (isset($arey)) ? $arey['description'] : ''; ?>" class="form-control" placeholder="" type="text" name="description" id="description"  data-toggle="popover" data-placement="top" data-content="">
            </div>
            <div class="help-block with-errors"></div>
        </div>
    </div>
    ...
    $(document).ready(function () {
        ...
        if ($('#file-1').attr('data-default') === '') {
            ...
            $("#file-1").fileinput({
                ...
                initialPreview: [
                    "<?php echo base_url('publik/rabmag/galeri'); ?>/" + $('#file-1').attr('data-default'),
                ],
