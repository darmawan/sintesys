        ...
        var opt1 = {
            ...
            "aoColumnDefs": [
                ...
                },
                {
                    "aTargets": [5],
                    "mRender": function (data, type, row) {
                        var bt = '<a href="javascript:;" class="btn btn-primary" rel="confirmUnPubish" title="Approve ' + row[2] + '" role="button" data-default="' + row[1] + '" data-value="' + row[0] + '" data-get="approveBerita/e"><i class="zmdi zmdi-check"></i></a>&nbsp;';
                        bt += '<a href="javascript:;" class="btn btn-danger" rel="confirmUnPubish" title="Batalakan status approve ' + row[2] + '" role="button" data-default="' + row[1] + '" data-value="' + row[0] + '" data-get="unapproveBerita/e"><i class="zmdi zmdi-close"></i></a>&nbsp;';
            ...
            "aoColumnDefs": [
                ...
                },
                {
                    ...
                    "mRender": function (data, type, row) {
                        ...
                        var retStr = (identifier == 1) ? '<span class="label label-success">Approved</span>' : '<span class="label label-danger">need approvement</span>';
                        return retStr;
                    }, sClass: "text-center", width: "120px"
                },
                {
                    "aTargets": [4],
                    "mRender": function (data, type, row) {
                ...
                },
                {
                    "aTargets": [5],
                    "mRender": function (data, type, row) {
                        var bt = '<a href="#" id="ojkConfirm" class="btn btn-primary" rel="confirmUnPubish" title="Approve ' + row[2] + '" role="button" data-default="' + row[1] + '" data-value="' + row[0] + '" data-get="approveBerita/m"><i class="zmdi zmdi-check"></i></a>&nbsp;';
                        bt += '<a href="#" id="ojkConfirm" class="btn btn-danger" rel="confirmUnPubish" title="Batalakan status approve ' + row[2] + '" role="button" data-default="' + row[1] + '" data-value="' + row[0] + '" data-get="unapproveBerita/m"><i class="zmdi zmdi-close"></i></a>&nbsp;';
        ...
        var opt3 = {
            ...
            "aoColumnDefs": [
                ...
                },
                {
                    "aTargets": [5],
                    "mRender": function (data, type, row) {
                        var bt = '<a href="#" id="ojkConfirm" class="btn btn-primary" rel="confirmUnPubish" title="Approve ' + row[2] + '" role="button" data-default="' + row[1] + '" data-value="' + row[0] + '" data-get="approveBerita/p"><i class="zmdi zmdi-check"></i></a>&nbsp;';
                        bt += '<a href="#" id="ojkConfirm" class="btn btn-danger" rel="confirmUnPubish" title="Batalkan status approve ' + row[2] + '" role="button" data-default="' + row[1] + '" data-value="' + row[0] + '" data-get="unapproveBerita/p"><i class="zmdi zmdi-close"></i></a>&nbsp;';
//                        bt += '<a href="article/getForm/' + row[1] + '/' + row[0] + '/e" class="btn btn-default" title="Edit"><i class="zmdi zmdi-edit"></i></a>';
                        return bt;
                    }, sClass: "p-5 text-center", width: "130px"
                },
        ...
        myApp.oTable = $('#dBerita').dataTable(opt0);
