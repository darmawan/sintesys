            ...
            <div class="box">
                ...
                <div class="box-content nopadding scrollable" data-height="350" data-visible="true" data-start="bottom">
                    <ul class="messages">
                        <li class="left">
                            <div class="image">
                                <img src="<?= base_url('assets/admin/img/demo/user-1.jpg') ?>" alt="">
                            </div>
                            <div class="message">
                        ...
                        <li class="right">
                            <div class="image">
                                <img src="<?= base_url('assets/admin/img/demo/user-2.jpg') ?>" alt="">
                            </div>
                            <div class="message">
                                <span class="caret"></span>
                        ...
                        <li class="typing">
                            <span class="name">John Doe</span> is typing <img src="<?= base_url('assets/admin/img/loading.gif') ?>" alt="">
                        </li>
                        <li class="insert">
                ...
                <div class="box-content nopadding scrollable" data-height="300" data-visible="true">
                    <table class="table table-user table-nohead">
                        <tbody>
                            ...
                            <tr>
                                <td class='img'><img src="<?= base_url('assets/admin/img/demo/user-1.jpg') ?>" alt=""></td>
                                <td class='user'>Bi Doe</td>
                                <td class='icon'><a href="#" class='btn'><i class="icon-search"></i></a></td>
                            </tr>
                            <tr>
                                <td class='img'><img src="<?= base_url('assets/admin/img/demo/user-2.jpg') ?>" alt=""></td>
                            ...
                            <tr>
                                <td class='img'><img src="<?= base_url('assets/admin/img/demo/user-3.jpg') ?>" alt=""></td>
                                <td class='user'>Dan Doe</td>
                                <td class='icon'><a href="#" class='btn'><i class="icon-search"></i></a></td>
                            </tr>
                            <tr>
                                <td class='img'><img src="<?= base_url('assets/admin/img/demo/user-4.jpg') ?>" alt=""></td>
                            ...
                            <tr>
                                <td class='img'><img src="<?= base_url('assets/admin/img/demo/user-5.jpg') ?>" alt=""></td>
                                <td class='user'>John Doe</td>
                                <td class='icon'><a href="#" class='btn'><i class="icon-search"></i></a></td>
                            </tr>
                            <tr>
                                <td class='img'><img src="<?= base_url('assets/admin/img/demo/user-6.jpg') ?>" alt=""></td>
                                <td class='user'>John Doe</td>
                                <td class='icon'><a href="#" class='btn'><i class="icon-search"></i></a></td>
                            </tr>
                            <tr class="alpha">
