...
if (isset($rowdata)) {
    ...
    foreach ($rowdata as $kolom => $nilai):
        $arey[$kolom] = $nilai;
    endforeach;
    $cid = ($salin == 'salin') ? '' : $arey['article_id'];
//    $cid = ($salin == '') ? (($arey['article_id'] == '') ? $aep : $arey['article_id']) : '';
...
if (isset($rowdataen)) {
    ...
    foreach ($rowdataen as $kolom => $nilai):
        $areyen[$kolom] = $nilai;
    endforeach;
    $cid = ($salin == 'salin') ? '' : (($cid == '') ? $areyen['article_id'] : $cid);
//    $cid = ($salin == '') ? (($cid == '') ? $areyen['article_id'] : $cid) : '';
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane <?php echo ($aep == '' || $bhs == 1) ? 'active' : ''; ?>" id="indonesia">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="fg-line">
                            <input value="<?= (isset($arey)) ? $arey['article_title'] : ''; ?>" class="form-control" placeholder="judul" type="text" name="article_title" id="article_title" required data-error="Wajib diisi."  data-toggle="popover" data-placement="top" data-content="">
                        </div>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo $this->lang->line('status_artikel', FALSE); ?></label>
                    <div class="col-sm-3">
                        <div class="select">
                            <select class="form-control selectpicker" data-live-search="false" name="status_article" id="status_article">
                                <?php
                                $n = $statusvalue;
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo $this->lang->line('tipe_artikel', FALSE); ?></label>
                    <div class="col-sm-3">
                        <div class="select">
                            <select class="form-control selectpicker" data-live-search="false" name="type_id" id="type_id">
                                ...
                                $k = $this->Data_model->selectData(DB_TYPE, 'type_id', array('type_grp' => 'article'));
                                foreach ($k as $m):
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label"><?php echo $this->lang->line('kategori_artikel', FALSE); ?></label>
                    <div class="col-sm-3">
                        <div class="select">
                            <select class="form-control selectpicker" data-live-search="false" name="cat_id" id="cat_id">
                                ...
                                $k = $this->Data_model->ambilDataWhere(DB_CATEGORY, array("1" => 1), "1", "asc", 'cat_id,name', 'cat_id,name');
                                foreach ($k as $m):
            ...
            <div role="tabpanel" class="tab-pane <?php echo ($bhs == 2) ? 'active' : ''; ?>" id="english">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="fg-line">
                            <input value="<?= (isset($areyen)) ? $areyen['article_title'] : ''; ?>" class="form-control" placeholder="title" type="text" name="article_title_en" id="article_title_en" <?php echo ($aep == '') ? '' : 'required'; ?> data-error="Wajib diisi."  data-toggle="popover" data-placement="top" data-content="">
                        </div>
                        <div class="help-block with-errors"></div>
                    </div>
                </div> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="select">
                            <select <?php echo (isset($arey) && $statusvalue <> '') ? (($statusvalueen <> 0) ? '' : ' disabled') : ''; ?> class="form-control selectpicker" data-live-search="false" name="status_article_en" id="status_article_en">
                                <?php
                                $n = $statusvalue;
                                $k = $this->Data_model->selectData(DB_STATUS, 'status');
                                foreach ($k as $m):
