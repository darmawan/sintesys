...
//                {"asSorting": ["asc"], "aTargets": [0]},
            ...
            "fnRowCallback": function (nRow, aoData, iDisplayIndex, iDisplayIndexFull) {
                $('td', nRow).on('click', function () {
                    ...
                    scrollKa($('.breadcrumb'));
//                    $("html,body").animate({scrollTop: $('#listartikel').offset().top - 100}, 300);
                    $("#cat_id").val(idRow);
                    $("#cat_name").val(titleRow);
                    $(".ttlAAtC").html("Tambah Artikel ke Kategori " + titleRow);
                    $(".ttlAAtG").html("Artikel dalam Kategori " + titleRow);
                    $("#addselection").fadeIn();
        ...
        myApp3.oTable = $('#dArticle').dataTable();
        myApp2.oTable = $('#dGroupArticle').dataTable({"bLengthChange": false});
        ...
        $("#addCatbtn").click(function () {
            ...
            $("#cat_id").val('');
            $(".ttlAAtC").html("Tambah Artikel ke Kategori " + $("#categorys").val());
            showGroupArticle(0);
            $("html,body").animate({scrollTop: $('#listartikel').offset().top - 100}, 300);
//            scrollKa($('#listartikel'));
            $("#addselection").show();
            $("#new-task").modal("hide")
        });
    ...
    function showGroupArticle(p) {
        var opt2 = {
            ...
            "bServerSide": true,
            "bDeferRender": true,
            "sAjaxSource": "getKategoryArtikel/" + p,
            "aaSorting": [[0, "asc"]],
            "aoColumnDefs": [
                {"sType": "numeric", "aTargets": [0]},
                {"asSorting": ["asc"], "aTargets": [0]},
...
//                {"bVisible": false, "aTargets": [1, 3, 4]},
        ...
        myApp2.oTable = $('#dGroupArticle').dataTable(opt2);
        null != myApp3.oTable && myApp3.oTable.fnDestroy();
        myApp3.oTable = $('#dArticle').dataTable(opt1);
