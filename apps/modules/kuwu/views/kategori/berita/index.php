        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div id="listkategori" class="card animated bounceInRight">
                    ...
                    <div class="clearfix m-b-0"></div> 
                    <div class="card-body">                         
                        <table class="table table-striped w-100" id="dGroupBerita">
                            <thead>
                                <tr>
                                    <?php
                                    if ($kolom2) {
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <form id="xfrm" role="form">
                    ...
                    <div id="listberita" class="card animated bounceInUp">                    
                        <div class="card-header bgm-indigo m-b-15">
                            <h2 class="ttlAAtC">Tambahkan Berita ke Kategori [tdk ada kategori terpilih]</h2>
                        ...
                        <div class="clearfix m-b-0"></div>
                        <div class="card-body"> 
                            <table class="table table-striped w-100" id="dBerita">
                                <thead>
                                    <tr>
                                        <th> Kode </th> 
                                        <th> Bahasa </th>
